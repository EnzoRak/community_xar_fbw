...
function p.__type_init(id)
    ...
    ia_ment_set_builtin_var_s(id, "__mesh", "MonsterMajorGuard")
    ia_ment_new_var_i(id, "health", 25609631, 60.0)
    ia_ment_new_static_var_f(id, "xp_mod", 4) --Very High!
    ia_ment_new_static_var_f(id, "dps", 500.0)
    ...
    ia_ment_new_static_var_s(id, "identity_str", "Major Guard")
