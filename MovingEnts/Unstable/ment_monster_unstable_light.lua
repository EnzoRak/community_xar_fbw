...
function p.__type_init(id)
    ...
    ia_ment_new_static_var_s(id, "identity_str", "Unstable Light")
    ...
    ia_ment_set_builtin_var_f(id, "__homing_speed", 30.0)
