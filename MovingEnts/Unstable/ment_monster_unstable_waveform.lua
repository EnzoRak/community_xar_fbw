...
function p.__type_init(id)
    ...
    ia_ment_set_builtin_var_f(id, "__radius", 0.67)
    ia_ment_set_builtin_var_s(id, "__mesh", "")
    ia_ment_new_var_i(id, "health", 10000000, 60.0)
    ...
    ia_ment_new_static_var_s(id, "identity_str", "Unstable Waveform")
    local aura_radius = 12.0
    ...
    ia_ment_set_builtin_var_f(id, "__homing_speed", 3.0)
...
function p.__on_render(inst_id)
    ...
    --
    --The rest is sWaveformly different from green shrinker rings.
