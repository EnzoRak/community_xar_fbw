        ...
        for y = 0,15 do
            for z = 0,15 do
                if randi(1,4) == 1 then
                    ...
                    if randi(1,4) == 1 then
                        set_pos(x,y,z,"anomaly")
                    else
                        if randi(1,4) == 1 then
                            local b = bents[randi(1,#bents)]
                            if b == "bent_base_txt" then
                                add_bent_s(x,y,z,b,rstr(randi(10,500)))
                            else
                                add_bent(x,y,z,b)
                            end
                        else
