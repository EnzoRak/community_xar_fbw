...
function p.__get_use_msg(level, pos)
    return "USE TO START THE SUNFLOWER RITUAL.    THERE IS NO RETURN"
end
...
function p.__on_use(level, pos)
    ...
    leveldecrementer = leveldecrementer + 1
    ga_ment_start(leveldecrementer, ga_chunk_id_and_lbp_to_bp(ga_get_viewer_ancestor_chunk_id(leveldecrementer), {x=7,y=7,z=7}), "ment_sun")
    ga_ment_end()
