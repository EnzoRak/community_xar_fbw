...
function p.__main()
    ...
    create_rect("block_sunflower_seedhead",0,0,0,15,15,15)
    if(get_input_path_block_var_exists(get_level()-1,"sundirection","i")) then
        ...
        if(sundirection ~= -1) then
            ...
            if(sundirection == 0)then
                coolsprinkles(15,1,1,15,14,14,0.2,"block_sunflower_spot")
                create_rect("XAR_EMPTY_BORING",7,1,1,14,14,14)
                set_pos(7,0,7,"XAR_BRISTOL_ONE_WAY_Y_POS")
                set_pos(7,15,7,"XAR_BRISTOL_ONE_WAY_Y_NEG")
            elseif(sundirection == 1)then
                coolsprinkles(0,1,1,0,14,14,0.2,"block_sunflower_spot")
                create_rect("XAR_EMPTY_BORING",1,1,1,7,14,14)
                set_pos(7,0,7,"XAR_BRISTOL_ONE_WAY_Y_POS")
                set_pos(7,15,7,"XAR_BRISTOL_ONE_WAY_Y_NEG")
            elseif(sundirection == 2)then
                coolsprinkles(1,15,1,14,15,14,0.2,"block_sunflower_spot")
                create_rect("XAR_EMPTY_BORING",1,7,1,14,14,14)
                set_pos(0,7,7,"XAR_BRISTOL_ONE_WAY_X_POS")
                set_pos(15,7,7,"XAR_BRISTOL_ONE_WAY_X_NEG")
            elseif(sundirection == 3)then
                coolsprinkles(1,0,1,14,0,14,0.2,"block_sunflower_spot")
                create_rect("XAR_EMPTY_BORING",1,1,1,14,7,14)
                set_pos(0,7,7,"XAR_BRISTOL_ONE_WAY_X_POS")
                set_pos(15,7,7,"XAR_BRISTOL_ONE_WAY_X_NEG")
            end
